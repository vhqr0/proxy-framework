...
from proxy.defaults import STREAM_BUFSIZE
from proxy.stream.errors import BufferOverflowError, IncompleteReadError
from proxy.stream.structs import BStruct, HStruct, IStruct, QStruct
